 ...
 *    1.1 Directly put @StateIndicator on getter method or on field, and state setter will never open for application
 *    1.2 Or to put @StateIndicator on Type definition, and provide a state indicator property name.
 *    
 * 2. Specify actions corresponding to the transitions defined at life cycle meta data with @Transition
 *    2.1 Leave @Transition with default value while the action method name equals with the transition class simple name
 *    2.2 Specify the transition value with the defined transition class when their names are not equal
 *    
 * @author Barry
 *
 */

...
import net.madz.lifecycle.solutionOne.InterceptContext;
import net.madz.lifecycle.solutionOne.InterceptorController;
        ...
        if ( argv.length == 2 && argv[0].endsWith(".class") ) {
            try {
                ...
                if ( index < methods.length ) {
                    ...
                    addWrapper(cgen, methods[index], innerClassSeq);
